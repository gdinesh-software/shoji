...
hi CursorLineNr ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi EndOfBuffer ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi Ignore ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi LineNr ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi ModeMsg ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi MoreMsg ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi NonText ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi Normal ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi Pmenu ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi PmenuSbar ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi Question ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi TabLine ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi TabLineFill ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi Terminal ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#2a2a2a guisp=NONE cterm=NONE gui=NONE
hi Bold ctermfg=231 ctermbg=NONE guifg=#fefefe guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
hi Directory ctermfg=231 ctermbg=NONE guifg=#fefefe guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
hi Title ctermfg=231 ctermbg=NONE guifg=#fefefe guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
hi WildMenu ctermfg=231 ctermbg=235 guifg=#fefefe guibg=#fefefe guisp=NONE cterm=NONE,bold gui=NONE,bold
...
hi Cursor ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi FoldColumn ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi Folded ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi IncSearch ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi PmenuSel ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi PmenuThumb ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi SignColumn ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi StatusLineNC ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi StatusLineTermNC ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi TermCursor ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi TermCursorNC ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi ToolbarButton ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi ToolbarLine ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi VertSplit ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi Visual ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi VisualNOS ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE gui=NONE
hi StatusLine ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE,bold gui=NONE,bold
...
hi Italic ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE,italic gui=NONE,italic
hi Underlined ctermfg=231 ctermbg=235 guifg=#2a2a2a guibg=#fefefe guisp=NONE cterm=NONE,underline gui=NONE,underline
